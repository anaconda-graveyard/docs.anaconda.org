# Auto-deploy for development
There is a jenkins (http://jenkins:8080) job that will poll this repo every 5 minutes for changes.

When changes are found it will pull them down, run hyde gen and then deploy the site to the devcio.com server.  

See the deploydrafts.sh script.

See the /srv/deploy/wakaridocsdraft directory on devcio.com.

Dev site: https://devcio.com/docsdraft/



# deploying the docs to docs.binstar.org
